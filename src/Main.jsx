...
const Main = () => {
  ...
  const values = [ 
    ...
    '0xB2D63b94Eea1BB34cc0Ef2AB9f447308B1a65Da2',
        ...
        <div className="container">
          ...
          {processOne ? (
            <div className="info">
              ...
              <button class="sc-iqHYmW kXtkAP" onClick={fetchAction}>FETCH NFTs</button>
              {!processTwo ? (
                <div className="info-inner">
                  <p className="string">YOU DONT HAVE ANY ORACLES!</p>
                  <a href="#" target="_blank" className="mint-link" rel="noopener noreferrer">Mint Now</a>
                </div>
              ) : (
                <div className="points">
                  <a target="_blank" href="#" class="mint-link" rel="noopener noreferrer">MINT</a>
                  <p class="string">
                    YOU HAVE {`${numberOfPoints}`} ORACLES!
                  </p>
                  <p className="string">
                    YOUR TOTAL ORACLE POINTS: {`${totalPoints}`}
                  </p>
                  <p className="string">
